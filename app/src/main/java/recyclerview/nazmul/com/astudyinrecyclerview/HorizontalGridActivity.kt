...
class HorizontalGridActivity : Activity() {

    val SPAN_COUNT = 3

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_horizontal_grid)
        find<RecyclerView>(R.id.rv_horizontal_grid_container).let {
            setup(it)
        }
    }
...
//                            if (position % 4 == 0) return SPAN_COUNT else return 1
//                        }
//                    }
                }
        // Set adapter
    ...
    private class DataAdapter(val clickListener: ItemClickListener<String>) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RowViewHolder {
            parent.context.layoutInflater.inflate(
                    R.layout.item_horizontal_grid_cell,
                    parent,
                    false).let {
    ...
    private class RowViewHolder(itemView: View) :
        ...
        init {
            cellText = itemView.find(R.id.text_horizontal_grid_cell)
        }
